...
@section('content')
    ...
    <div class="portlet-body">
        ...
        @if(session()->has('error'))
            {{session('error')}}
        @endif
        <form class="form-horizontal" role="form" method="post" action="{{route('panel.acenteler.store')}}">
            @csrf
            <div class="form-body">
                    ...
                    <div class="col-md-9">
                        <div class="mt-radio-inline">
                            <label class="mt-radio">
                                <input type="radio" name="durum" id="optionsRadios25" value="1" checked>
                                Aktif
                                <span></span>
                            </label>
                            <label class="mt-radio">
                                <input type="radio" name="durum" id="optionsRadios26" value="0">
                                Pasif
                                <span></span>
                            </label>
                        </div>
