    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{route('panel.dashboard')}}">
                <img src="https://placehold.co/106x17" alt="logo" class="logo-default"/> </a>
        ...
        <div class="page-actions">
            <div class="btn-group">
                <button type="button" class="btn red-haze btn-sm dropdown-toggle" data-toggle="dropdown"
                    ...
                    <span class="hidden-sm hidden-xs">Hızlı İşlemler&nbsp;</span>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{url('/')}}/assets/layouts/layout3/img/avatar2.jpg"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{url('/')}}/assets/layouts/layout3/img/avatar3.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="{{url('/')}}/assets/layouts/layout3/img/avatar1.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <span class="username username-hide-on-mobile"> Yönetici </span>
                            <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
                            <img alt="" class="img-circle" src="https://placehold.co/39x39"/>
                        </a>
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                <li class="nav-itemstart active">
                    <a href="{{route('panel.dashboard')}}" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                ...
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        ...
                        <span class="title">Acenteler</span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="{{route('panel.acenteler.create')}}" class="nav-link ">
                                <span class="title">Acente Ekle</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('panel.acenteler.index')}}" class="nav-link ">
                                <span class="title">Acente Listesi</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="heading">
                    <h3 class="uppercase">Acente</h3>
                </li>
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-settings"></i>
                        <span class="title">Acente Yönetimi</span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="" class="nav-link ">
                                <span class="title">Acente Ayarları</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link ">
                                <span class="title">Tur Ayarları</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-flag"></i>
                        <span class="title">Turlar</span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="" class="nav-link ">
                                <span class="title">Tur Ekle</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link ">
                                <span class="title">Tur Listesi</span>
                            </a>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="page-quick-sidebar-chat-user-messages">
                                <div class="post out">
                                    <img class="avatar" alt=""
                                         src="{{url('/')}}/assets/layouts/layout/img/avatar3.jpg"/>
                                    <div class="message">
                                        <span class="arrow"></span>
                                ...
                                <div class="post in">
                                    <img class="avatar" alt=""
                                         src="{{url('/')}}/assets/layouts/layout/img/avatar2.jpg"/>
                                    <div class="message">
                                        <span class="arrow"></span>
...
<div class="page-footer">
    <div class="page-footer-inner"> 2025 &copy; Acente Yönetim Yazılımı</div>
